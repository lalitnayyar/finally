...
<required_reading>
@/home/lnayyar/projects/CourseAIVibeCodeUdmey/finally/.codex/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/lnayyar/projects/CourseAIVibeCodeUdmey/finally/.codex/get-shit-done/bin/gsd-tools.cjs" init resume)
