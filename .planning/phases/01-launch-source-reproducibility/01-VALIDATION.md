...
| 01-03-01 | 03 | 2 | PLAT-02 | T-01-09 | UI and API are served from the same containerized origin | e2e | `cd /home/lnayyar/projects/CourseAIVibeCodeUdmey/finally && python3 scripts/smoke_start_command.py && cd test && npx playwright test specs/launch.spec.ts specs/reproducibility.spec.ts` | Planned in 01-03 | ⬜ pending |
