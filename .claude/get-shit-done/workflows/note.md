...
- **Global scope**: `/home/lnayyar/projects/CourseAIVibeCodeUdmey/finally/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/lnayyar/projects/CourseAIVibeCodeUdmey/finally/.claude/notes/`)
...
2. Glob `/home/lnayyar/projects/CourseAIVibeCodeUdmey/finally/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/lnayyar/projects/CourseAIVibeCodeUdmey/finally/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/lnayyar/projects/CourseAIVibeCodeUdmey/finally/.claude/notes/` — works in any directory
